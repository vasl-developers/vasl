...
installation of VASSAL, and the VASL module.  Start the VASSAL
application with the org.vassalengine.Main main class and load the
VASL module.  See VASSAL's programming tutorial for an overview of how
to use the API.
