...
public class SunBlindnessShaderComponent extends AbstractBuildable implements GameComponent, CommandEncoder {

    private static final Logger logger = LoggerFactory.getLogger(SunBlindnessShaderComponent.class);

    private final char ENCODING_DELIM = '|';
    private final String COMMAND_PREFIX = "command.shader.sun_blindness" + ENCODING_DELIM;
    ...
    public Command getRestoreCommand() {
        ...
        if (env.isNight()) {
            ...
            restoreCommand = new DeactivateSunBlindnessShaderCommand();
        }
    ...
    public String encode(Command command) {
        ...
        if (command instanceof ActivateSunBlindnessShaderCommand) {
            encoder.append(true);
