...
public class LowVisibilityShaderComponent extends AbstractBuildable implements GameComponent, CommandEncoder {

    private static final Logger logger = LoggerFactory.getLogger(LowVisibilityShaderComponent.class);

    private final char ENCODING_DELIM = '|';
    private final String COMMAND_PREFIX = "command.shader.low_visibility" + ENCODING_DELIM;
    ...
    public Command getRestoreCommand() {
        ...
        if (env.isLV()) {
            ...
            restoreCommand = new DeactivateLowVisibilityShaderCommand();
        }
    ...
    public String encode(Command command) {
        ...
        if (command instanceof ActivateLowVisibilityShaderCommand) {
            encoder.append(true);
